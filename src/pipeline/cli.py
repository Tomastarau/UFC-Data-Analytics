...
from src.pipeline.config import DEFAULT_DELAY
from src.pipeline.fighter_photos import enrich_fighter_photos
from src.pipeline.orchestrator import run_ingestion
from src.pipeline.logging_config import setup_logging
...
def check_quality() -> None:
    ...
    from src.pipeline.quality import run_all_checks
